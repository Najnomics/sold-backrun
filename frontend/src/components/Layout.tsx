...
const TITLES: Record<string, { eyebrow: string; title: string }> = {
  ...
  "/swap": { eyebrow: "Trade", title: "Retail swap posts a right" },
  ...
  "/about": { eyebrow: "Docs", title: "How Sold Backrun works" },
};

export function Layout() {
  const [open, setOpen] = useState(false);
  const loc = useLocation();
  const meta = TITLES[loc.pathname] ?? { eyebrow: "Sold Backrun", title: "" };
      ...
      <aside className={`sidebar ${open ? "open" : ""}`}>
        <div className="sb-brand">
          ...
          <div className="sb-title">
            Sold Backrun
            <small>RETAIL SELLS THE BACKRUN</small>
          </div>
        </div>
    ...
    <footer className="footer">
      <div className="footer-inner">
        <div className="footer-brand">
          ...
          <div>
            <div className="footer-name">Sold Backrun</div>
            <p className="footer-tag">
              Retail sells the backrun. First-price ERC-20 bids and surplus skims are donated to in-range LPs.
            </p>
        ...
        <div className="footer-cols">
          ...
          <div className="footer-col">
            ...
            <a href="https://github.com/Najnomics/sold-backrun" target="_blank" rel="noreferrer">
              Repository
            </a>
            <a href="https://github.com/Najnomics/sold-backrun" target="_blank" rel="noreferrer">
              GitHub
      ...
      <div className="footer-bar">
        <span>© {year} Sold Backrun · MIT License</span>
